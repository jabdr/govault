...
Copyright 2026 Johannes Drummer
...
Please note: We cannot be held liable for any data loss that may occur while using govault.
This includes passwords, attachments, and other information handled by the application.
We highly recommend performing regular backups of your files and database.
